            ...
            <div className="mx-auto max-w-7xl px-6 py-16">
                <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        >
                            <span className="text-2xl font-black text-white">viva</span>
                            <span className="text-2xl font-black text-vb-accent">byte</span>
                        </a>
                        <p className="text-sm leading-relaxed text-vb-muted">{t('footer.tagline')}</p>
                    </div>
                                ...
                                {LOCALES.map((lang) => (
                                    <a
                                        ...
                                        className={[
                                            ...
                                            lang === locale ? 'text-white' : 'text-vb-muted hover:text-white',
                                        ].join(' ')}
                                    >
                                        {lang}
                                    </a>
                ...
                <div className="border-t border-white/10 pt-8 text-center">
                    <p className="text-xs text-vb-muted">{t('footer.copyright')}</p>
                </div>
            </div>
        </footer>
    );
